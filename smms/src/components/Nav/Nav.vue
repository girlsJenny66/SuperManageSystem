<template>
  ...
  >
    ...
    <el-submenu index="3">
      <template slot="title"><i class="el-icon-goods"></i>进货管理</template>
    ...
    <el-submenu index="4">
      ...
      <el-menu-item index="/goodsoutofstock">商品出库</el-menu-item>
      <el-menu-item index="/returngoods">商品退货</el-menu-item>
    </el-submenu>
